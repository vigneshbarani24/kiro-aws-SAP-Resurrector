...
**Resurrection ID:** 9a2e784d-e3e7-49fc-a633-b328badd36a0
...
1. **Calculate sales order total with various pricing conditions**
   - Status: ✅ Preserved
   - Implementation: CAP service handler

2. **Apply discounts, tax, and check against customer credit limit**
   - Status: ✅ Preserved
   - Implementation: CAP service handler
