...
**Project:** kiro-demo-showdown
**Generated:** 2025-12-05
**Resurrection ID:** 42dae68e-0852-45af-be29-26a30c7710a6
...
This document describes the functional requirements and transformation details for the resurrection of the ABAP application "kiro-demo-showdown" to a modern SAP Cloud Application Programming (CAP) model.
...
1. **Calculates the total for a sales order including discounts, tax, and checks against customer's credit limit.**
   - Status: ✅ Preserved
   - Implementation: CAP service handler

2. **Applies bulk discount based on subtotal exceeding a threshold.**
   - Status: ✅ Preserved
   - Implementation: CAP service handler
