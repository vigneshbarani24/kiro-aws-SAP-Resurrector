...
**Project:** kiroween-test
**Generated:** 2025-12-05
**Resurrection ID:** 6abecfc4-ec97-4af3-86f2-7ecbd3f250d0
...
This document describes the functional requirements and transformation details for the resurrection of the ABAP application "kiroween-test" to a modern SAP Cloud Application Programming (CAP) model.
...
- **JOIN pattern for combining header and item tables**
  - SAP-specific implementation pattern
- **Selection screen pattern for report parameter input**
  - SAP-specific implementation pattern
...
- ABAP Dictionary for data element definitions
- Database for EKKO and EKPO tables
...
1. **Generate report for open purchase orders with quantities and price**
   - Status: ✅ Preserved
   - Implementation: CAP service handler

2. **Filter open POs by selection criteria and calculate open quantities**
   - Status: ✅ Preserved
   - Implementation: CAP service handler
