...
**Resurrection ID:** 9da3288e-cb87-415a-8729-5c89f96dcab4
...
This document describes the functional requirements and transformation details for the resurrection of the ABAP application "abap" to a modern SAP Cloud Application Programming (CAP) model.

### 1.2 Scope

Uploaded 1 ABAP file(s)
