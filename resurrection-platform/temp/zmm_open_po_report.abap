...
FORM display_list.
  ...
  WRITE: / sy-vline,
           ...
           (10) 'PO Qty', sy-vline,
           (10) 'GR Qty', sy-vline,
           (10) 'Open Qty', sy-vline,
           (10) 'Net Price', sy-vline.
  ULINE.

  LOOP AT gt_open_po INTO gs_open_po.
    WRITE: / sy-vline,
             gs_open_po-ebeln UNDER 'PO Number', sy-vline,
             gs_open_po-ebelp UNDER 'Item', sy-vline,
             gs_open_po-lifnr UNDER 'Vendor', sy-vline,
             gs_open_po-werks UNDER 'Plant', sy-vline,
             gs_open_po-matnr UNDER 'Material', sy-vline,
             gs_open_po-menge UNDER 'PO Qty', sy-vline,
             gs_open_po-wemng UNDER 'GR Qty', sy-vline,
             gs_open_po-open_qty UNDER 'Open Qty', sy-vline,
             gs_open_po-netpr UNDER 'Net Price', sy-vline.
  ENDLOOP.
ENDFORM.
